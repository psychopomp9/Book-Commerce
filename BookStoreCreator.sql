...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `Book_Commerce` ;
...
-- -----------------------------------------------------
-- Table `Book_Commerce`.`orders`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Book_Commerce`.`orders` ;

CREATE TABLE IF NOT EXISTS `Book_Commerce`.`orders` (
  ...
  CONSTRAINT `fk_orders_user`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_item_inventory1`
